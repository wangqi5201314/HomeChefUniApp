  ...
  <view class="page">
    <view class="profile-card">
      ...
      <view class="profile-info">
        ...
        <text class="summary">账号状态：{{ chefStatusText }}</text>
...
<style scoped>
.page { min-height: 100vh; padding: 24rpx; background: linear-gradient(180deg, #eef7f1 0%, #f6f7fb 34%, #f6f7fb 100%); box-sizing: border-box; }
.profile-card, .menu-card { border-radius: 28rpx; background: #ffffff; box-shadow: 0 12rpx 32rpx rgba(32, 37, 43, 0.06); }
.profile-card { display: flex; align-items: center; padding: 36rpx 32rpx; }
.avatar-wrap { flex-shrink: 0; }
.avatar { width: 136rpx; height: 136rpx; border-radius: 50%; background: #e5efe8; }
.avatar-placeholder { display: flex; align-items: center; justify-content: center; }
.avatar-text { font-size: 48rpx; font-weight: 600; color: #2f8f55; }
.profile-info { flex: 1; min-width: 0; margin-left: 28rpx; }
.name-row { display: flex; align-items: center; gap: 14rpx; flex-wrap: wrap; }
.name { font-size: 38rpx; font-weight: 600; color: #1f2329; }
.cert-tag { padding: 8rpx 16rpx; border-radius: 999rpx; background: #edf8f1; font-size: 22rpx; color: #2f8f55; }
.phone { display: block; margin-top: 14rpx; font-size: 28rpx; color: #6b7280; }
.summary { display: block; margin-top: 12rpx; font-size: 26rpx; color: #5f6671; }
...
.menu-sub { font-size: 24rpx; color: #7d8794; }
.menu-arrow { font-size: 34rpx; color: #b0b7c3; }
.logout-btn { width: 100%; height: 88rpx; margin-top: 28rpx; line-height: 88rpx; border: none; border-radius: 999rpx; background: #ffffff; box-shadow: 0 12rpx 32rpx rgba(32, 37, 43, 0.06); font-size: 30rpx; color: #d14a4a; }
