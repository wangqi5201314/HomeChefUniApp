...
<style scoped>
.page { min-height: 100vh; padding: 24rpx; background: linear-gradient(180deg, #edf7f0 0%, #f6f7fb 36%, #f6f7fb 100%); box-sizing: border-box; }
.profile-card, .menu-card { border-radius: 28rpx; background: #ffffff; box-shadow: 0 14rpx 36rpx rgba(28, 39, 31, 0.06); }
.profile-card { display: flex; padding: 32rpx; }
.avatar { width: 128rpx; height: 128rpx; border-radius: 50%; background: #e5efe8; }
.avatar-placeholder { display: flex; align-items: center; justify-content: center; }
.avatar-text { font-size: 44rpx; font-weight: 600; color: #2f8f55; }
.profile-info { flex: 1; margin-left: 24rpx; }
.name { display: block; font-size: 36rpx; font-weight: 600; color: #1f2329; }
.phone { display: block; margin-top: 12rpx; font-size: 26rpx; color: #67716c; }
.summary { display: block; margin-top: 12rpx; font-size: 24rpx; color: #738078; line-height: 1.7; }
.menu-card { margin-top: 24rpx; padding: 0 28rpx; }
.menu-item { display: flex; align-items: center; justify-content: space-between; min-height: 108rpx; border-bottom: 2rpx solid #eef1ef; }
.menu-item.last { border-bottom: none; }
.menu-main { display: flex; flex-direction: column; gap: 8rpx; }
.menu-text { font-size: 30rpx; color: #1f2329; }
.menu-sub { font-size: 24rpx; color: #738078; }
.menu-arrow { font-size: 30rpx; color: #b0b7c3; }
.logout-btn { width: 100%; height: 88rpx; margin-top: 32rpx; line-height: 88rpx; border: none; border-radius: 999rpx; background: #ffffff; box-shadow: 0 14rpx 36rpx rgba(28, 39, 31, 0.06); font-size: 30rpx; color: #d14a4a; }
