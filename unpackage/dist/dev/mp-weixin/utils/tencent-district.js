...
const utils_tencentMap = require("./tencent-map.js");
...
function requestTencentDistrict(url, data = {}) {
  return new Promise((resolve, reject) => {
    common_vendor.index.request({
      ...
      method: "GET",
      data: {
        key: utils_tencentMap.TENCENT_MAP_KEY,
        output: "json",
        ...data
      },
      success: (res) => {
...
exports.getDistrictChildren = getDistrictChildren;
exports.getDistrictTree = getDistrictTree;
//# sourceMappingURL=../../.sourcemap/mp-weixin/utils/tencent-district.js.map
