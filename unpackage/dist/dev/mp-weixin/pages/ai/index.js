...
const _sfc_main = {
  ...
  methods: {
    initMessages() {
      const cached = common_vendor.index.getStorageSync(utils_auth.AI_CHAT_HISTORY_KEY);
    ...
    persistMessages() {
      common_vendor.index.setStorageSync(utils_auth.AI_CHAT_HISTORY_KEY, this.messages);
    },
    abortCurrentRequest() {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-0c8adc5a"]]);
